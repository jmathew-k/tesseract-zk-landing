        ...
        <Section>
            <div className="container md:py-10 lg:pt-16 xl:pt-20">
                <Heading
                    ...
                    textLarge="Get started with Tesseract - AI chat app today and experience the power of AI in your conversations!"
                />
                    ...
                    <div className="flex-1">
                        ...
                        <div className="relative mb-16">
                            ...
                            <div className="body-2 text-n-2">
                                <p className="mb-6">
                                    {`To create an account with Tesseract - AI
                                        ...
                                        various features. Tesseract's AI chat
                                ...
                                <p className="mb-6">
                                    ...
                                    world, Tesseract is the perfect choice.
                                </p>
                            </div>
                            <div
